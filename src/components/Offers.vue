<template>
    <section class="realEstate">
        <div class="invest">
            <div class="invest1">
                <h2>Great Offers Just For You</h2>
                <p>You dont have to break the bank to buy what you need, we have 
made available several offers to make sure you save on purchases.</p>
            </div>
            <div class="invest2">
